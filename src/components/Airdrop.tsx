...
export function  Airdrop(){
    ...
    return(
        <div className="flex justify-between p-2">
            ...
            <input placeholder="Enter SOL amount"  className="border-2 border-amber-400 rounded-2xl p-2"
             onChange={(e)=>{
                setAmount(e.target.value)
            }}></input>
            <button  className="p-2 bg-amber-400 rounded-xl text-amber-50" onClick={handleSendAirdrop}>Send Airdrop</button>
            </div>
            </div>
            <div className="p-4">
